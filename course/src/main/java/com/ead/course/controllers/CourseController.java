...
public class CourseController {
    ...
    public ResponseEntity<Object> saveCourse(@RequestBody CourseDto courseDto, Errors errors){
        ...
        BeanUtils.copyProperties(courseDto, courseModel);//converte courseDto para courseModel
    ...
    public ResponseEntity<Object> deleteCourse(@PathVariable(value = "courseId") UUID courseId){
        ...
        courseService.delete(courseModelOptional.get());//como é um optional, devemos colocar o .get()

        log.debug("DELETE deleteCourse courseId {} deleted!", courseId);
        log.info("Course deleted success! courseId {}", courseId);
    ...
    public ResponseEntity<Object> updateCourse(@PathVariable(value = "courseId") UUID courseId,
        ...
        log.debug("PUT updateCourse courseId {}", courseId);
        Optional<CourseModel> courseModelOptional = courseService.findById(courseId);
        if(!courseModelOptional.isPresent()){
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Course not found!");
        }
